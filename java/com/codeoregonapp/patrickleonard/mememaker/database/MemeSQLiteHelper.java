...
public class MemeSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_MEMES__TABLE =
    ...
    private static final String CREATE_ANNOTATIONS_TABLE = "CREATE TABLE " + ANNOTATIONS_TABLE + " (" +
            BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(CREATE_MEMES__TABLE);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        switch(oldVersion) {
            case 1:  {
                db.execSQL(ALTER_ADD_CREATED_DATE);
            }
        }
